...
**相关类型：**
- `ConnectionConfig`: 连接配置，详见 [连接配置文档](3.1连接配置.md)
- `TransportProtocol`: 传输协议类型，详见 [连接配置文档](3.1连接配置.md)
...
**返回值：**  
`ConnectionState` 枚举值，详见 [连接配置文档](3.1连接配置.md)
...
**相关文档：**  
详见 [Callback 参考](3.4Callback参考.md) 中 `IControlCallback` 类的说明。
...
**相关文档：**  
详见 [Callback 参考](3.4Callback参考.md) 中 `IDataCallback` 类的说明。
...
**说明：**  
获取机器人的控制权。如果当前 APP 在控制，则无法抢占接管。详见 [sdk控制权归属](3.5SDK控制权归属.md)
